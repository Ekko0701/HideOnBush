...
<p align="center">
  <a href="https://github.com/Ekko0701/HideOnBush/releases/latest">
    <img alt="Latest release" src="https://img.shields.io/badge/release-v0.1.2-blue?style=flat-square">
  </a>
...
```bash
./scripts/package-homebrew.sh 0.1.2
```

Generated files:

```text
release/HideOnBush-v0.1.2-macos-arm64.zip
release/homebrew/Casks/hideonbush.rb
```

Release flow:

1. Create a GitHub Release such as `v0.1.2`.
2. Upload `HideOnBush-v0.1.2-macos-arm64.zip`.
...
```bash
./scripts/release-notarized.sh 0.1.2
```
